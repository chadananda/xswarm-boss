...
from assistant.voice.moshi_server import start_moshi_server
from assistant.voice.moshi_client import MoshiClient
...
def main():
    ...
    process, client_to_server, server_to_client, status_queue = start_moshi_server(quality)
